...
export default function PropertyCard({ property }: { property: Property }) {
    const getRateDisplay = () => {
        ...
        if (rates.monthly) {
            ...
            return `${rates.nightly.toLocaleString()} руб/ночь`;
        }
    };
            ...
            <div className="p-4">
                ...
                <div className="flex justify-center gap-4 text-gray-500 mb-4">
                    ...
                    <p>
                        ...
                        <span className="md:hidden lg:inline"> Ванные комнаты</span>
                    </p>
                    <p>
                ...
                <div className="flex justify-center gap-4 text-green-900 text-sm mb-4">
                    {property.rates.nightly && (
                        <p>
                            <FaMoneyBill className="md:hidden lg:inline mr-2" /> На сутки
                        </p>
                    )}

                    {property.rates.weekly && (
                        <p>
                            <FaMoneyBill className="md:hidden lg:inline mr-2" /> На неделю
                        </p>
                    )}
                    {property.rates.monthly && (
                        <p>
                            <FaMoneyBill className="md:hidden lg:inline mr-2" /> На месяц
                        </p>
                    )}
                </div>
